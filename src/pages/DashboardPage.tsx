          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm uppercase tracking-[0.3em] text-accent-primary">Submissions</p>
                  <h2 className="mt-3 text-4xl font-bold text-text-primary">{submissions.length}</h2>
                </div>
